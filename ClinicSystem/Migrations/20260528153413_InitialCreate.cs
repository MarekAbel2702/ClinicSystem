    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Lekarz pierwszego kontaktu dla osób dorosłych.", "Internista" },
                    { 2, "Lekarz zajmujący się diagnostyką i leczeniem dzieci.", "Pediatra" },
                    { 3, "Specjalista chorób serca i układu krążenia.", "Kardiolog" },
                    { 4, "Specjalista chorób skóry.", "Dermatolog" },
                    { 5, "Specjalista układu ruchu, kości i stawów.", "Ortopeda" },
                    { 6, "Specjalista chorób układu nerwowego.", "Neurolog" }
                });
